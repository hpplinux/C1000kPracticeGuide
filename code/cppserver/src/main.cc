...
// å‘½ä»¤ç®¡é“
/***
[HP]Õâ¸ö±äÁ¿Ã»ÓĞ³õÊ¼»¯¹ı£¬Ö±½ÓÊ¹ÓÃ£¬ºÜ‡å
ÍÆ²âÊÇµ÷ÓÃÁËpipeº¯Êı£¬½ÓÊÜ½ø³ÌºÍ¹¤×÷½ø³ÌÖ®¼äÍ¨ĞÅÓÃµÄ
**/
int sv[MAX_CPU][2] = {};
...
/**
È«¾ÖµÄacceptµ½µÄfdµÄÁ´±í£¬Ã¿Ò»¸öitemÊµ¼Ê¶¼ÊÇÒ»×éfdµÄÊı×é¡£
**/
...
int main() {
    ...
    // pipe
    signal(SIGPIPE, SIG_IGN);  // sigpipe ä¿¡å·å±è”½
